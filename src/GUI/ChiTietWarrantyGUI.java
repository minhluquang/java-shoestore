...
public class ChiTietWarrantyGUI extends JFrame {
    ...
    public ChiTietWarrantyGUI(Warranty wt, WarrantyGUI parentGUI) {
        ...
        btnNewButton_1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                int choice = JOptionPane.showConfirmDialog(null, "Bạn có muốn huỷ bỏ chỉnh sửa chi tiết bảo hành không?",
                        "Xác nhận huỷ bỏ chỉnh sửa chi tiết bảo hành", JOptionPane.YES_NO_OPTION);
                if (choice == JOptionPane.YES_OPTION) {
                    dispose();
                }
            }
    ...
    public void xuLyTuDongGanGiaTri() {
        ...
        // Không cần thiết lập giá trị cho trường Active ở đây
    }
    ...
    public void xuLyLuuThongTinBaoHanh() {
        ...
        if (!isExistWarId) {
            if (WarrantyBUS.insertWar(warranty_id, product_id, wardate, reason, "OK", warstatus, true)) {
            ...
            if (WarrantyBUS.updateWar(warranty_id, product_id, wardate, reason, "OK", warstatus)) {
